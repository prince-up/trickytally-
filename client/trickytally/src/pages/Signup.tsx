    ...
    <div style={styles.container}>
      ...
      <div style={styles.imageSection}>
        <div style={styles.imageOverlay}>
          <div style={styles.imageContent}>
            ...
            <p style={styles.brandTagline}>Master the Game, Track the Glory</p>
          </div>
        </div>
      </div>
      ...
      <div style={styles.formSection}>
        <div style={styles.card}>
          ...
          <h2 style={styles.subtitle}>Join TrickTally</h2>
          <p style={styles.formInstruction}>Create your account to start tracking sessions</p>
